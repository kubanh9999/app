...
// }
export function getDummyImage(filename: string) {
  return `https://theme.hstatic.net/200000427375/1000801978/14/${filename}?v=511`;
}
export function getDummyImage_brand(filename: string) {
  return `https://theme.hstatic.net/200000427375/1000801978/14/${filename}?v=511`;
}
...
const pay = (amount: number, description?: string) =>
  createOrder({
    ...
    amount: amount,
    success: (data) => {
      console.log("Payment success132: ", data);
    },
    fail: (err) => {
